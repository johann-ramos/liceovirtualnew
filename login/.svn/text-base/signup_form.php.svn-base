...
class login_signup_form extends moodleform {
    function definition() {
        ...
        if (fullname($nameordercheck) == 'd c b a' ) {  // See MDL-4325
            $mform->addElement('text', 'secondlastname',  get_string('secondlastname'),  'maxlength="100" size="30"');
        ...
        $mform->addRule('middlename', get_string('missingmiddlename'), 'visible', null, 'server');
